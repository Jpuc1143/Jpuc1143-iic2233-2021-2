# Constantes de la generación de juegos
...
AUMENTAR_ENERGIA = 30
PONDERADOR_AUMENTAR_FUERZA = 0.2
AUMENTAR_AGILIDAD = 3
AUMENTAR_INGENIO = 3


# Constantes de las características de los ambientes
VELOCIDAD_VIENTOS_PLAYA = 100
HUMEDAD_PLAYA = 100

NUBOSIDAD_MONTANA = 100
PRECIPITACIONES_MONTANA = 100
